...
//    {
//        StartCoroutine(
//            RequestDataToServer<InappItemData>("getInappItems", 0.15f, "inapp", "InappItemData",GameData.Instance.inappItemList,LoadPriceData));
//    }

//    // 가격 정보 로딩.
//    void LoadPriceData()
//    {
//        StartCoroutine(RequestDataToServer<PriceData>("getPrices", 0.2f, "price", "PriceData", "codeNo",GameData.Instance.priceDic,LoadItemData));
//    }

//    // 보유한 아이템 로딩.
//    void LoadItemData()
//    {
//        StartCoroutine(RequestDataToServer<ItemData>("getUserItem", 0.3f, "useritem", "ItemData",GameData.Instance.itemList,LoadFriendData));
//    }

//    // 친구 데이터 로딩.
//    void LoadFriendData()
//    {
//        StartCoroutine(RequestDataToServer<FriendData>("getFriendListWithFB", 0.6f, "friendlist", "FriendData",GameData.Instance.friendList,LoadMessageData));
//    }

//    // 메시지 데이터 로딩.
//    void LoadMessageData()
//    {
//        StartCoroutine(RequestDataToServer<MessageData>("getUserMessage", 0.9f, "usermessage", "MessageData",GameData.Instance.messageList, GoToLobbyScene));
//    }
...
//    {
//        Application.OpenURL(string.Format(GameData.Instance.urlPrefix,"postCustomerService"));
//    }
...
//                        PopupWarningMessage("사용자 데이터가 없습니다.\n운영자에게 문의하세요.",OpenCustomerServicePage);
//                    }
//                    else
//                    {
//                        // error : 데이터를 다시 로딩하는 경우.
//                        PopupWarningMessage("데이터를 다시 로딩합니다",LoadUserData);
//                        ++loadRetryCounter;
//                    }
//                    break;
//                default:
...
//                    GameData.Instance.ConvertData(www.text, rootNode, dataNode, targetList);
